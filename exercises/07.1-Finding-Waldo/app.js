...
for(i=0 ; i<largo ; i++){
    ...
    if(people[i] ==mayuwaldo  || people[i] == minuwaldo){
        
        conteo=conteo+1;
        console.log('# hallazgos: '+conteo);
